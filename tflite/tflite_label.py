...
pathModel = "C:\\Users\\Pandu\\Documents\\python\\model\\handwashing_kfold_8sep21.tflite"
...
def textCv(nilai, gerakan):
    ...
    for item in range(6):
        ...
        cv2.putText(frame1, "gerakan ke: {}, Durasi : {}".format(listLabel, durasi),(20, yPost), cv2.FONT_HERSHEY_PLAIN, 1, (color), 0)
...
while True:
    try:
        ...
        # cv2image = cv2.cvtColor(frameR, cv2.COLOR_BGR2RGBA)
